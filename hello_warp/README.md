...
This is a simple Hello World web application built with the [Warp](https://github.com/seanmonstar/warp) framework.
...
```sh
curl http://127.0.0.1:3030/hello/Alice
```
